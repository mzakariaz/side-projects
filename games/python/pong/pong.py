...
# Original code provided by Christian Thompson, and expanded upon by Zakaria Zerrouki in this file
...
paddle_a.shapesize(stretch_wid=2.5,stretch_len=0.5)
paddle_a.penup()
paddle_a.goto(-350, 0)
...
paddle_b.shapesize(stretch_wid=2.5,stretch_len=0.5)
paddle_b.penup()
paddle_b.goto(350, 0)
